...
{  public static void main(String[] args) throws Exception
   {  
      ReadMensagem mensagem = new ReadMensagem();
      mensagem.openFile();
      String   sMsgClara = mensagem.lerMensagem();
      mensagem.closeFile();
      ...
      CreateTextoCriptografado createFileCrpt = new CreateTextoCriptografado();
      CreateTextoDecifrado createFileDeci = new CreateTextoDecifrado();
      ...
      String sMsgCifrada1 = (new String (bMsgCifrada, "ISO-8859-1"));
      // Imprime cabecalho da mensagem
      ...
      System.out.println(sMsgCifrada1);
      System.out.println("");
      // Imprime texto
      ...
      // Converte o texto byte[] no equivalente String
      String sMsgDecifrada1 = (new String (bMsgDecifrada, "ISO-8859-1"));
      ...
      System.out.println(sMsgDecifrada1);
      System.out.println(""); 
      /*
       * Criptografia AES --------------------------------------------------------------
       */
      ...
      // Converte o texto byte[] no equivalente String
      String sMsgCifrada2 = (new String (bMsgCifrada, "ISO-8859-1"));
      // Imprime cabecalho da mensagem
      System.out.println("Mensagem Cifrada (Hexadecimal):");
      // Imprime o texto cifrado em Hexadecimal
      System.out.print(prn.hexBytesToString(bMsgCifrada));
      ...
      System.out.println("Mensagem Cifrada (String):");
      // Imprime o texto cifrado em String
      System.out.println(sMsgCifrada2);
      System.out.println("");
      // Imprime texto
      ...
      // Converte o texto byte[] no equivalente String
      String sMsgDecifrada2 = (new String (bMsgDecifrada, "ISO-8859-1"));
      // Imprime cabecalho da mensagem
      System.out.println("Mensagem Decifrada (Hexadecimal):");
      // Imprime o texto decifrado em Hexadecimal
      System.out.print(prn.hexBytesToString(bMsgDecifrada));
      ...
      System.out.println("Mensagem Decifrada (String):");
      // Imprime o texto decifrado em String
      System.out.println(sMsgDecifrada2);
      System.out.println(""); 
      /*
       * Criptografia RSA --------------------------------------------------------------
       */
      ...
      // Converte o texto byte[] no equivalente String
      String sMsgCifrada3 = (new String (bMsgCifrada, "ISO-8859-1"));
      // Imprime cabecalho da mensagem
      System.out.println("Mensagem Cifrada (Hexadecimal):");
      // Imprime o texto cifrado em Hexadecimal
      System.out.print(prn.hexBytesToString(bMsgCifrada));
      ...
      System.out.println("Mensagem Cifrada (String):");
      // Imprime o texto cifrado em String
      System.out.println(sMsgCifrada3);
      System.out.println("");
      // Imprime texto
      ...
      // Converte o texto byte[] no equivalente String
      String sMsgDecifrada3 = (new String (bMsgDecifrada, "ISO-8859-1"));
      // Imprime cabecalho da mensagem
      System.out.println("Mensagem Decifrada (Hexadecimal):");
      // Imprime o texto decifrado em Hexadecimal
      System.out.print(prn.hexBytesToString(bMsgDecifrada));
      ...
      System.out.println("Mensagem Decifrada (String):");
      // Imprime o texto decifrado em String
      System.out.println(sMsgDecifrada3);
      System.out.println("");
      sMsgCifrada = sMsgCifrada1 +"\n"+sMsgCifrada2+"\n"+sMsgCifrada3+"\n";
      createFileCrpt.openFile();
      createFileCrpt.addTexto(sMsgCifrada);
      createFileCrpt.closeFile();

      sMsgDecifrada = sMsgDecifrada1 +"\n"+sMsgDecifrada2+"\n"+sMsgDecifrada3+"\n";
      createFileDeci.openFile();
      createFileDeci.addTexto(sMsgDecifrada);
      createFileDeci.closeFile();
