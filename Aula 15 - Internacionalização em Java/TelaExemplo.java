...
{  private JButton bt;
   ...
   {  // Menu simples de escolha de idioma
      ...
      switch(op)
      {  case  1: bn = ResourceBundle.getBundle("ex1", new Locale("pt", "BR")); // Idioma composto = sempre colocar país e idioma
                  break;
         case  2: bn = ResourceBundle.getBundle("ex1", Locale.US); // Idioma "puro" = apenas o país
                  break;
